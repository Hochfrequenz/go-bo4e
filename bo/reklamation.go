...
type Reklamation struct {
	...
	Grund        reklamationsgrund.Reklamationsgrund `json:"grund" validate:"required"`                                                                                    //
	...
	Zeitraum     *com.Zeitraum                       `json:"zeitraum,omitempty" validate:"required"`                                                                       // Rechnungsnummer ist eine im Verwendungskontext eindeutige Nummer für die Rechnung
}
