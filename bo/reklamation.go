...
type Reklamation struct {
	...
	Reklamationsgrund       reklamationsgrund.Reklamationsgrund `json:"grund,omitempty" validate:"required"`                                                                          // The reason for the complaint
	...
	ZeitraumMesswertanfrage *com.Zeitraum                       `json:"zeitraum,omitempty" validate:"required"`                                                                       // Zeitraum defines the com.Zeitraum where the Energiemenge is complained
}
