...
type Marktteilnehmer struct {
	Geschaeftspartner
	Marktrolle       marktrolle.Marktrolle       `json:"marktrolle,omitempty" validate:"required"`                   // Gibt im Klartext die Bezeichnung der Marktrolle an. Details siehe ENUM Marktrolle
	...
	Rollencodetyp    rollencodetyp.Rollencodetyp `json:"rollencodetyp,omitempty" validate:"required"`                // Gibt den Typ des Codes an/Vergabestelle. Details siehe ENUM Rollencodetyp
