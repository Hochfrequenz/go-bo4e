...
type Rechnung struct {
	...
	Rechnungsnummer         string                          `json:"Eine im Verwendungskontext eindeutige Nummer für die Rechnung." validate:"required"` // Eine im Verwendungskontext eindeutige Nummer für die Rechnung
	...
	//Rechnungspositionen []com.Rechnungsposition	`json:"rechnungspositionen"validate:"required,min=1"` // Die Rechnungspositionen. Details siehe COM Rechnungsposition
}
