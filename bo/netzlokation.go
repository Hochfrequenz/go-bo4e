...
type Netzlokation struct {
	...
	Verwendungszweck           *com.Verwendungszweck  `json:"verwendungszweck,omitempty"`                                                 // Deprecated: Verwendungungszweck der Werte Netzlokation genutzt vor FV2610
	Verwendungszwecke          []com.Verwendungszweck `json:"verwendungszwecke,omitempty"`                                                // Verwendungungszwecke der Werte Netzlokation
