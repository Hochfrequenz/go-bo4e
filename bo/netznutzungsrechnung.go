...
type Netznutzungsrechnung struct {
	...
	Nnrechnungsart       nnrechnungsart.NNRechnungsart `json:"nnrechnungsart,omitempty" validate:"required"`                      // Aus der INVOIC entnommen
	Nnrechnungstyp       nnrechnungstyp.NNRechnungstyp `json:"nnrechnungstyp,omitempty" validate:"required"`                      // Aus der INVOIC entnommen
