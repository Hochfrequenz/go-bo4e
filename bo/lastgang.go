...
type Lastgang struct {
	...
	Version      string                      `json:"version" validate:"alphanum"`                                                                        // Versionsnummer des Lastgangs
	...
	Messgroesse  mengeneinheit.Mengeneinheit `json:"einheit" validate:"required" example:"KWH"`                                                          // Definition der gemessenen Größe anhand ihrer Einheit.
