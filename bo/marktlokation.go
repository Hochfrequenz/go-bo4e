...
type Marktlokation struct {
	Geschaeftsobjekt
	MarktlokationsId     string                                    `json:"marktlokationsId" example:"" validate:"required,numeric,len=11"` // ID of the market location
	...
	Endkunde             Geschaeftspartner                         `json:"endkunde,omitempty"`                                             // Link to the Geschaeftspartner who owns this market location
