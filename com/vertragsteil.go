...
type Vertragsteil struct {
	Vertragsteilbeginn       *time.Time `json:"vertragsteilbeginn,omitempty" validate:"omitempty"`                         // Vertragsteilbeginn ist der inklusive Start der Gültigkeit des Vertragsteils
