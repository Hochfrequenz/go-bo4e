...
type Preisposition struct {
	...
	Preiseinheit             waehrungseinheit.Waehrungseinheit    `json:"preiseinheit" validate:"required"`                       // Festlegung, mit welcher Preiseinheit abgerechnet wird, z.B. Ct. oder €
	Bezugsgroesse            mengeneinheit.Mengeneinheit          `json:"bezugsgroesse" validate:"required"`                      // Hier wird festgelegt, auf welche Bezugsgrösse sich der Preis bezieht, z.B. kWh oder Stück
