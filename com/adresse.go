...
type Adresse struct {
	Postleitzahl *string                `json:"postleitzahl,omitempty" example:"82031" validate:"numeric"`    // Postleitzahl is the zip code, mandatory
	Ort          *string                `json:"ort,omitempty" example:"Grünwald" validate:"alphaunicode"`     // Ort is the city name, mandatory
