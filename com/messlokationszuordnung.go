...
type Messlokationszuordnung struct {
	...
	GueltigSeit     time.Time                                     `json:"gueltigSeit"`                                                   // GueltigSeit ist der inklusive Zeitpunkt, ab dem die Messlokation zur Marktlokation gehört
	GueltigBis      time.Time                                     `json:"gueltigbis"`                                                    // GueltigBis ist der exklusive Zeitpunkt, bis zu dem die Messlokation zur Marktlokation gehört
}
