...
type Tagesparameter struct {
	Klimazone            string `json:"klimazone,omitempty" validate:"alphanum" example:"7624q"`                // Klimazone is the qualifier of the climate zone
	Temperaturmessstelle string `json:"temperaturmessstelle,omitempty" validate:"alphanum" example:"1234x"`     // Klimazone is the qualifier of the temperature measurement station
	...
	Herausgeber          string `json:"herausgeber,omitempty" example:"BDEW"`                                   // Herausgeber is the publisher of the Tagesparameter. As of 2022-03-29 its value can be either 'BDEW' or 'HAENDLER'.
