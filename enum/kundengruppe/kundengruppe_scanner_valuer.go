...
func (r Kundengruppe) Value() (driver.Value, error) {
...
func (r *Kundengruppe) Scan(src interface{}) error {
	f := typemapper.TypeFromValue[Kundengruppe]
	v, err := f(src, _KundengruppeNameToValue)
	if err != nil {
		return err
	}
