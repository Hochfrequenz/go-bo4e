...
func (r Angebotsstatus) Value() (driver.Value, error) {
...
func (r *Angebotsstatus) Scan(src interface{}) error {
	f := typemapper.TypeFromValue[Angebotsstatus]
	v, err := f(src, _AngebotsstatusNameToValue)
	if err != nil {
		return err
	}
