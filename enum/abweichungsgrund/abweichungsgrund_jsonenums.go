...
var (
	_AbweichungsGrundNameToValue = map[string]AbweichungsGrund{
		...
		"BEGINN_DES_ABRECHNUNGSZEITRAUMS_VOR_2024":                                                   BEGINN_DES_ABRECHNUNGSZEITRAUMS_VOR_2024,
		"ERWARTETE_POSITION_NICHT_VORHANDEN":                                                         ERWARTETE_POSITION_NICHT_VORHANDEN,
		"KEIN_IMS_IM_GESAMTEN_ABRECHNUNGSZEITRAUM":                                                   KEIN_IMS_IM_GESAMTEN_ABRECHNUNGSZEITRAUM,
		"MSB_IM_ABRECHNUNGSZEITRAUM_NICHT_IMMER_ZUGEORDNET":                                          MSB_IM_ABRECHNUNGSZEITRAUM_NICHT_IMMER_ZUGEORDNET,
		"MSB_IM_GESAMTEN_ABRECHNUNGSZEITRAUM_NICHT_ZUGEORDNET":                                       MSB_IM_GESAMTEN_ABRECHNUNGSZEITRAUM_NICHT_ZUGEORDNET,
		"ARTIKELID_DER_POSITION_NICHT_IM_GESAMTEN_POSITIONSZEITRAUM_GUELTIG":                         ARTIKELID_DER_POSITION_NICHT_IM_GESAMTEN_POSITIONSZEITRAUM_GUELTIG,
		"ARTIKELID_FUER_RECHNUNGSTYP_IM_POSITIONSZEITRAUM_NICHT_ZULAESSIG":                           ARTIKELID_FUER_RECHNUNGSTYP_IM_POSITIONSZEITRAUM_NICHT_ZULAESSIG,
	}
...
func init() {
	...
	if _, ok := interface{}(v).(fmt.Stringer); ok {
		_AbweichungsGrundNameToValue = map[string]AbweichungsGrund{
			...
			interface{}(BEGINN_DES_ABRECHNUNGSZEITRAUMS_VOR_2024).(fmt.Stringer).String():                                                   BEGINN_DES_ABRECHNUNGSZEITRAUMS_VOR_2024,
			interface{}(ERWARTETE_POSITION_NICHT_VORHANDEN).(fmt.Stringer).String():                                                         ERWARTETE_POSITION_NICHT_VORHANDEN,
			interface{}(KEIN_IMS_IM_GESAMTEN_ABRECHNUNGSZEITRAUM).(fmt.Stringer).String():                                                   KEIN_IMS_IM_GESAMTEN_ABRECHNUNGSZEITRAUM,
			interface{}(MSB_IM_ABRECHNUNGSZEITRAUM_NICHT_IMMER_ZUGEORDNET).(fmt.Stringer).String():                                          MSB_IM_ABRECHNUNGSZEITRAUM_NICHT_IMMER_ZUGEORDNET,
			interface{}(MSB_IM_GESAMTEN_ABRECHNUNGSZEITRAUM_NICHT_ZUGEORDNET).(fmt.Stringer).String():                                       MSB_IM_GESAMTEN_ABRECHNUNGSZEITRAUM_NICHT_ZUGEORDNET,
			interface{}(ARTIKELID_DER_POSITION_NICHT_IM_GESAMTEN_POSITIONSZEITRAUM_GUELTIG).(fmt.Stringer).String():                         ARTIKELID_DER_POSITION_NICHT_IM_GESAMTEN_POSITIONSZEITRAUM_GUELTIG,
			interface{}(ARTIKELID_FUER_RECHNUNGSTYP_IM_POSITIONSZEITRAUM_NICHT_ZULAESSIG).(fmt.Stringer).String():                           ARTIKELID_FUER_RECHNUNGSTYP_IM_POSITIONSZEITRAUM_NICHT_ZULAESSIG,
		}
	}
}
