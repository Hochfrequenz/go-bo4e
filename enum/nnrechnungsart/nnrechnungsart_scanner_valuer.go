...
func (r NNRechnungsart) Value() (driver.Value, error) {
...
func (r *NNRechnungsart) Scan(src interface{}) error {
	f := typemapper.TypeFromValue[NNRechnungsart]
	v, err := f(src, _NNRechnungsartNameToValue)
	if err != nil {
		return err
	}
