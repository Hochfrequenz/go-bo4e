...
var (
	_GrundlageEnergiemengeNameToValue = map[string]GrundlageEnergiemenge{
		"ZAEHLERSTAND_ZUM_BEGIN_DER_ANGEGEBENEN_ENERGIEMENGE_VORHANDEN_UND_KOMMUNIZIERT":          ZAEHLERSTAND_ZUM_BEGIN_DER_ANGEGEBENEN_ENERGIEMENGE_VORHANDEN_UND_KOMMUNIZIERT,
...
func init() {
	...
	if _, ok := interface{}(v).(fmt.Stringer); ok {
		_GrundlageEnergiemengeNameToValue = map[string]GrundlageEnergiemenge{
			interface{}(ZAEHLERSTAND_ZUM_BEGIN_DER_ANGEGEBENEN_ENERGIEMENGE_VORHANDEN_UND_KOMMUNIZIERT).(fmt.Stringer).String():          ZAEHLERSTAND_ZUM_BEGIN_DER_ANGEGEBENEN_ENERGIEMENGE_VORHANDEN_UND_KOMMUNIZIERT,
