...
func _() {
	...
	_ = x[ART_STANDARDEINSPEISEPROFIL-4]
	_ = x[ART_TAGESPARAMETERABHAENGIGES_EINSPEISEPROFIL-5]
}

const _Profilart_name = "ART_STANDARDLASTPROFILART_TAGESPARAMETERABHAENGIGES_LASTPROFILART_LASTPROFILART_STANDARDEINSPEISEPROFILART_TAGESPARAMETERABHAENGIGES_EINSPEISEPROFIL"

var _Profilart_index = [...]uint8{0, 22, 62, 76, 103, 148}
