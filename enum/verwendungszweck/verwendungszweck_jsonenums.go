...
var (
	_VerwendungszweckNameToValue = map[string]Verwendungszweck{
		...
		"SELBSTVERBRAUCH":                         SELBSTVERBRAUCH,
		"ES_LIEGT_KEIN_VERWENDUNGSZWECK_VOR":      ES_LIEGT_KEIN_VERWENDUNGSZWECK_VOR,
		"KEINE_DATENLIEFERUNG_AN_MARKTROLLE":      KEINE_DATENLIEFERUNG_AN_MARKTROLLE,
	}
...
func init() {
	...
	if _, ok := interface{}(v).(fmt.Stringer); ok {
		_VerwendungszweckNameToValue = map[string]Verwendungszweck{
			...
			interface{}(SELBSTVERBRAUCH).(fmt.Stringer).String():                         SELBSTVERBRAUCH,
			interface{}(ES_LIEGT_KEIN_VERWENDUNGSZWECK_VOR).(fmt.Stringer).String():      ES_LIEGT_KEIN_VERWENDUNGSZWECK_VOR,
			interface{}(KEINE_DATENLIEFERUNG_AN_MARKTROLLE).(fmt.Stringer).String():      KEINE_DATENLIEFERUNG_AN_MARKTROLLE,
		}
	}
}
