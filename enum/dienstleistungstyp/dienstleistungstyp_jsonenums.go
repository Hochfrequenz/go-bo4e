// Code generated by jsonenums --type Dienstleistungstyp; DO NOT EDIT.
...
var (
	_DienstleistungstypNameToValue = map[string]Dienstleistungstyp{
		...
		"AUSLESUNG_LGK_MANUELL_MSB":                   AUSLESUNG_LGK_MANUELL_MSB,
		"AUSLESUNG_MONATLICH_SLP_FERNAUSLESUNG":       AUSLESUNG_MONATLICH_SLP_FERNAUSLESUNG,
		"AUSLESUNG_JAEHRLICH_SLP_FERNAUSLESUNG":       AUSLESUNG_JAEHRLICH_SLP_FERNAUSLESUNG,
		"AUSLESUNG_MDE_SLP":                           AUSLESUNG_MDE_SLP,
		"ABLESUNG_MONATLICH_SLP":                      ABLESUNG_MONATLICH_SLP,
		"ABLESUNG_VIERTELJAEHRLICH_SLP":               ABLESUNG_VIERTELJAEHRLICH_SLP,
		"ABLESUNG_HALBJAEHRLICH_SLP":                  ABLESUNG_HALBJAEHRLICH_SLP,
		"ABLESUNG_JAEHRLICH_SLP":                      ABLESUNG_JAEHRLICH_SLP,
		"AUSLESUNG_SLP_FERNAUSLESUNG":                 AUSLESUNG_SLP_FERNAUSLESUNG,
		"ABLESUNG_SLP_ZUSAETZLICH_MSB":                ABLESUNG_SLP_ZUSAETZLICH_MSB,
		"ABLESUNG_SLP_ZUSAETZLICH_KUNDE":              ABLESUNG_SLP_ZUSAETZLICH_KUNDE,
		"AUSLESUNG_LGK_FERNAUSLESUNG_ZUSAETZLICH_MSB": AUSLESUNG_LGK_FERNAUSLESUNG_ZUSAETZLICH_MSB,
		"ABLESUNG_MONATLICH_LGK":                      ABLESUNG_MONATLICH_LGK,
		"AUSLESUNG_TEMERATURMENGENUMWERTER":           AUSLESUNG_TEMERATURMENGENUMWERTER,
		"AUSLESUNG_VORGANG_SLP":                       AUSLESUNG_VORGANG_SLP,
		"AUSLESUUNG_KOMPAKTMENGENUMWERTER":            AUSLESUUNG_KOMPAKTMENGENUMWERTER,
		"AUSLESUNG_MDE_LGK":                           AUSLESUNG_MDE_LGK,
		"SPERRUNG_SLP":                                SPERRUNG_SLP,
		"ENTSPERRUNG_SLP":                             ENTSPERRUNG_SLP,
		"SPERRUNG_RLM":                                SPERRUNG_RLM,
		"ENTSPERRUNG_RLM":                             ENTSPERRUNG_RLM,
	}

	_DienstleistungstypValueToName = map[Dienstleistungstyp]string{
		DATENBEREITSTELLUNG_TAEGLICH:                "DATENBEREITSTELLUNG_TAEGLICH",
		DATENBEREITSTELLUNG_WOECHENTLICH:            "DATENBEREITSTELLUNG_WOECHENTLICH",
		DATENBEREITSTELLUNG_MONATLICH:               "DATENBEREITSTELLUNG_MONATLICH",
		DATENBEREITSTELLUNG_JAEHRLICH:               "DATENBEREITSTELLUNG_JAEHRLICH",
...
func init() {
	...
	if _, ok := interface{}(v).(fmt.Stringer); ok {
		_DienstleistungstypNameToValue = map[string]Dienstleistungstyp{
			...
			interface{}(AUSLESUNG_LGK_MANUELL_MSB).(fmt.Stringer).String():                   AUSLESUNG_LGK_MANUELL_MSB,
			interface{}(AUSLESUNG_MONATLICH_SLP_FERNAUSLESUNG).(fmt.Stringer).String():       AUSLESUNG_MONATLICH_SLP_FERNAUSLESUNG,
			interface{}(AUSLESUNG_JAEHRLICH_SLP_FERNAUSLESUNG).(fmt.Stringer).String():       AUSLESUNG_JAEHRLICH_SLP_FERNAUSLESUNG,
			interface{}(AUSLESUNG_MDE_SLP).(fmt.Stringer).String():                           AUSLESUNG_MDE_SLP,
			interface{}(ABLESUNG_MONATLICH_SLP).(fmt.Stringer).String():                      ABLESUNG_MONATLICH_SLP,
			interface{}(ABLESUNG_VIERTELJAEHRLICH_SLP).(fmt.Stringer).String():               ABLESUNG_VIERTELJAEHRLICH_SLP,
			interface{}(ABLESUNG_HALBJAEHRLICH_SLP).(fmt.Stringer).String():                  ABLESUNG_HALBJAEHRLICH_SLP,
			interface{}(ABLESUNG_JAEHRLICH_SLP).(fmt.Stringer).String():                      ABLESUNG_JAEHRLICH_SLP,
			interface{}(AUSLESUNG_SLP_FERNAUSLESUNG).(fmt.Stringer).String():                 AUSLESUNG_SLP_FERNAUSLESUNG,
			interface{}(ABLESUNG_SLP_ZUSAETZLICH_MSB).(fmt.Stringer).String():                ABLESUNG_SLP_ZUSAETZLICH_MSB,
			interface{}(ABLESUNG_SLP_ZUSAETZLICH_KUNDE).(fmt.Stringer).String():              ABLESUNG_SLP_ZUSAETZLICH_KUNDE,
			interface{}(AUSLESUNG_LGK_FERNAUSLESUNG_ZUSAETZLICH_MSB).(fmt.Stringer).String(): AUSLESUNG_LGK_FERNAUSLESUNG_ZUSAETZLICH_MSB,
			interface{}(ABLESUNG_MONATLICH_LGK).(fmt.Stringer).String():                      ABLESUNG_MONATLICH_LGK,
			interface{}(AUSLESUNG_TEMERATURMENGENUMWERTER).(fmt.Stringer).String():           AUSLESUNG_TEMERATURMENGENUMWERTER,
			interface{}(AUSLESUNG_VORGANG_SLP).(fmt.Stringer).String():                       AUSLESUNG_VORGANG_SLP,
			interface{}(AUSLESUUNG_KOMPAKTMENGENUMWERTER).(fmt.Stringer).String():            AUSLESUUNG_KOMPAKTMENGENUMWERTER,
			interface{}(AUSLESUNG_MDE_LGK).(fmt.Stringer).String():                           AUSLESUNG_MDE_LGK,
			interface{}(SPERRUNG_SLP).(fmt.Stringer).String():                                SPERRUNG_SLP,
			interface{}(ENTSPERRUNG_SLP).(fmt.Stringer).String():                             ENTSPERRUNG_SLP,
			interface{}(SPERRUNG_RLM).(fmt.Stringer).String():                                SPERRUNG_RLM,
			interface{}(ENTSPERRUNG_RLM).(fmt.Stringer).String():                             ENTSPERRUNG_RLM,
		}
	}
}

// MarshalJSON is generated so Dienstleistungstyp satisfies json.Marshaler.
func (r Dienstleistungstyp) MarshalJSON() ([]byte, error) {
	if s, ok := interface{}(r).(fmt.Stringer); ok {
		return json.Marshal(s.String())
	}
	s, ok := _DienstleistungstypValueToName[r]
	if !ok {
		return nil, fmt.Errorf("invalid Dienstleistungstyp: %d", r)
	}
	return json.Marshal(s)
}

// UnmarshalJSON is generated so Dienstleistungstyp satisfies json.Unmarshaler.
func (r *Dienstleistungstyp) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("Dienstleistungstyp should be a string, got %s", data)
	}
	v, ok := _DienstleistungstypNameToValue[s]
	if !ok {
		return fmt.Errorf("invalid Dienstleistungstyp %q", s)
	}
	*r = v
	return nil
}
