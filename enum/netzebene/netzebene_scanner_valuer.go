...
func (r Netzebene) Value() (driver.Value, error) {
...
func (r *Netzebene) Scan(src interface{}) error {
	f := typemapper.TypeFromValue[Netzebene]
	v, err := f(src, _NetzebeneNameToValue)
	if err != nil {
		return err
	}
